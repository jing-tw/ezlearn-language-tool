...
void CSourceStream::Debug_PrintCommand(Command &com){
	//CMD_INIT, CMD_PAUSE, CMD_RUN, CMD_STOP, CMD_EXIT
	switch(com){
		case CMD_INIT:
			OutputDebugString(_T("CMD_INIT\n"));
			break;
		case CMD_RUN:
			OutputDebugString(_T("CMD_RUN\n"));
			break;
		case CMD_PAUSE:
			OutputDebugString(_T("CMD_PAUSE\n"));
			break;
		case CMD_STOP:
			OutputDebugString(_T("CMD_STOP\n"));
			break;
		case CMD_EXIT:
			OutputDebugString(_T("CMD_EXIT\n"));
			break;
		default:
...
HRESULT CSourceStream::DoBufferProcessingLoop(void) {
	...
	//OutputDebugString(_T("----------------------------> Â÷¶}\n"));
	//MessageBox(NULL,_T("Â÷¶}"),_T("test"),MB_OK);
	return S_FALSE;
}
